	...
	<div class="container-fluid" id="reseacher">
		...
		<div class="container" >
			...
			<div class="card recard" >
				<div class="row">
					<div class="col-md-3" >
						<img src="images/harsha-lad.jpg" class="card-image  image-responsive img-thumbnail reimage" alt="Harsha Lad">
					</div>
					<div class="col-md-9 cardmd9">
						<div class="card-block cardblk">
			...
			<div class="card recard">
				<div class="row">
					<div class="col-md-3" >
						<img src="images/r8.jpeg" class="card-image  image-responsive img-thumbnail reimage" alt="Deepti Dixit">
					</div>
					<div class="col-md-9 cardmd9">
						<div class="card-block cardblk">
			...
			<div class="card recard">
				<div class="row">
					<div class="col-md-3" >
						<img src="images/savita-sharma.jpg" class="card-image  image-responsive img-thumbnail reimage" alt="Savita Sharma">
					</div>
					<div class="col-md-9 cardmd9">
						<div class="card-block cardblk">
