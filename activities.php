...
<body>
	...
	<div id="Activities" class="container-fluid">
		...
		<div class="container cont-marg" id="cont-margs">
			...
			<div class="no-jumbo row text-center">
				<div class="image-item image-act">	
					<a href="#"><div class="display-4 text-block"><h3>14/03/2018</h3></div></a>
				</div>
			...
			<div class="no-jumbo row text-center">
				<div class="image-item image-act">	
					<a href="#"><div class="display-4 text-block"><h3>02/12/2017</h3></div></a>
				</div>
			...
			<div class="no-jumbo row text-center">
				<div class="image-item image-act">	
					<a href="#"><div class="display-4 text-block"><h3>05/09/2017</h3></div></a>
				</div>
