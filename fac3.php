	...
	<div class="container-fluid fac-back">
		<div class="container fac">
			<div class="fac-profile">
				<img class="fac-image-lg" src="images/fac3_cover.jpeg">
				<img class="fac-image-profile img-thumbnail" src="images/fac3.jpeg" alt="profile image example">
			...
			<div class="fac-body">
				...
				<section>
					...
					<div class="fac-content" id="publications">
						<p>Download list of publications from here : &nbsp&nbsp<a href="docs/faculty/Publications_Meeta_Jain.pdf" class="btn btn-info btn-sm" download="Dr.Meeta_Jain_Publications">DOWNLOAD</a></p>
					</div>
				</section>
			</div>
		</div>
