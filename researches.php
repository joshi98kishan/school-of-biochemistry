	...
	<div class="container" >
		...
		<div class="card recard">
			<div class="row">
				<div class="col-md-12 cardmd9" >
					<div class="card-block cardblk" >
						<h6 class="card-title divstyle1"><strong>Mamta Hirve</strong></h6>
						<div class="divstyle1"><span class="profile-topic"><strong>Year : </strong></span> <span class="profile-topic-detail">2015</span></div>
						<div class="divstyle1"><span class="profile-topic"><strong>Supervisor : </strong></span> <span class="profile-topic-detail">Dr. Meeta Jain</span></div>
					</div>
				</div>
			</div>
